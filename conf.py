...
BLOG_AUTHOR = "Kevin Minkus"  # (translatable)
BLOG_TITLE = "Kevin Minkus"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kmink.us/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kmink.us/"
BLOG_EMAIL = "kminkus24@gmail.com"
BLOG_DESCRIPTION = "Site for my blog"  # (translatable)
